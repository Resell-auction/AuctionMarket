...
//                org.apache.http.HttpEntityEnclosingRequest entityEnclosingRequest = (org.apache.http.HttpEntityEnclosingRequest) request;
//                if(entityEnclosingRequest.getEntity() != null){
//                    byte[] content = org.apache.http.util.EntityUtils.toByteArray(entityEnclosingRequest.getEntity());
//                    sdkHttpFullRequest.contentStreamProvider(()->new java.io.ByteArrayInputStream(content));
//                }
//            }
//
